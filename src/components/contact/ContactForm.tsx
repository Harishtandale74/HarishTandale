  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!validation.isValid) {
        ...
        setSubmitMessage(`Please fix the following errors: ${validation.errors.join(', ')}`);
      ...
      if (result.success) {
        ...
        setSubmitMessage(
          `Thank you ${formData.name}! Your message has been sent successfully via Web3Forms to harishtandale956@gmail.com. ` +
      ...
      setSubmitStatus('error');
      setSubmitMessage(
        'There was an error sending your message. Please try again or contact me directly at harishtandale956@gmail.com. ' +
  ...
  const contactInfo = [
    {
      ...
      label: 'Email',
      value: 'harishtandale956@gmail.com',
    ...
    },
    {
      ...
      label: 'Location',
      value: 'PCE, Nagpur, India',
      href: null,
    },
  ];

  return (
    <Section title="Get In Touch" subtitle="Have a question or want to work together? Send me a message!">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="p-2 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-primary-100 dark:hover:bg-primary-900 transition-colors"
                  aria-label="GitHub"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  href="https://instagram.com/jsxsnippet" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-2 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-primary-100 dark:hover:bg-primary-900 transition-colors"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white transition-colors resize-vertical"
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                * Required fields. Your message will be sent via Web3Forms to harishtandale956@gmail.com
              </p>
            </form>
          </div>
        </motion.div>
